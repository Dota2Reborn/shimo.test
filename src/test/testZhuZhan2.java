...
public class testZhuZhan2 {
	public WebDriver driver = null;
	WebDriverWait wait;
	
	@BeforeMethod
	public void setUp() throws Exception {
		//System.setProperty("webdriver.firefox.bin", "C:\\Program Files (x86)\\Firefox\\firefox.exe");//火狐
		System.setProperty("webdriver.chrome.driver", "C:\\Program Files (x86)\\Google\\Chrome\\Application\\chromedriver.exe");//谷歌
...
//		userEmail.sendKeys("panpan@qq.com");
//		userPwd.sendKeys("123123");
//		login_submit.click();
...
//	    driver.switchTo().window(it.get(1)); 
		...
		xpath_login.click();
		wait.until(ExpectedConditions.elementToBeClickable(By.partialLinkText("登录")));
		driver.findElement(By.partialLinkText("登录")).click();
		wait.until(ExpectedConditions.elementToBeClickable(login_submit));
		userEmail.sendKeys("liuchen@shimo.im");
		userPwd.sendKeys("123123");
		login_submit.click();
...
//	    driver.switchTo().window(it.get(2)); 
	...
	//仅企业创建者和管理员
	@Test
	public void testQiYeGL_inviteMember2() throws InterruptedException {
		wait.until(ExpectedConditions.elementToBeClickable(xpath_QYGL));
		xpath_QYGL.click();
		Set<String> winHandels = driver.getWindowHandles(); 
	    List<String> it = new ArrayList<String>(winHandels); 
	...
	public void testQiYeGL_inviteMember3() throws InterruptedException {
		...
		driver.findElement(By.partialLinkText("登录")).click();
		wait.until(ExpectedConditions.elementToBeClickable(login_submit));
		userEmail.sendKeys("pipi@qq.com");
		userPwd.sendKeys("123123");
		login_submit.click();
...
//		Thread.sleep(1500);
	...
	public void testQiYeGL_addCollaborators_3() throws InterruptedException {
		...
		driver.findElement(By.partialLinkText("登录")).click();
		wait.until(ExpectedConditions.elementToBeClickable(login_submit));
		userEmail.sendKeys("shimo03@sina.com");
		userPwd.sendKeys("123123");
		login_submit.click();
...
//	    wait.until(ExpectedConditions.refreshed(condition));
	    ...
	    Thread.sleep(1000);
//	    wait.until(ExpectedConditions.numberOfElementsToBeLessThan(By.className("row"), 1));
	    elements = driver.findElements(By.className("row"));  
		number=elements.size();  //成员列表
		Boolean user2;
		if(number==8){user2 = true;}
		else{user2 = false;}
	...
	public void testQiYeGL_banUser() throws InterruptedException {
		...
		String aa = "//div[@class='waterfall-inner']//div[" + n + "]//div[@class='action']//div//div[@class='dropdown-toggle']";
		String bb = "//div[@class='waterfall-inner']//div[" + n + "]//div[@class='action']//div//div[@class='dropdown-menu dropdown-menu-right']//span[@class='dropdown-item red']";
